...
ggplot(Tang.skinny) +
  ...
  ggtitle('Rain Variation Vs Time for Tang') + xlab('Year') + ylab('Rainfall Variation') + 
  theme_minimal()
```
...
graph <- ggplot(data=Challa) + geom_smooth(mapping=aes(x=`varve number`, y=`dark layer`, color="dark layer"), se=FALSE)  + geom_smooth(mapping=aes(x=`varve number`, y=`varve thickness`, color="varve thickness" ),se=FALSE) + geom_smooth(mapping=aes(x=`varve number`, y=`light layer`,color="light layer" ),se=FALSE) + labs(title="Rainfall in Challa Over Time", x="Time", y="Amount of Rain") +  scale_colour_manual("", 
