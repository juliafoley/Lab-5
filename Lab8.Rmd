...
Question 1: This is interesting because it will show whether or not a team will win at home. I think that it is interesting to see if there is a trend between winnings and location. It is interesting to see if being the home team impacts the probability of a win. Additionally, it will be interesting to see if a team with a better record overall has a higher probability of winning at home or if there is another factor that goes into it. 
