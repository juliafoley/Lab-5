...
#### Conclusion 
<p>
In conclusion, during the space race, there was a corrilation betwen GDP per-capita. the percentile was 95.1%, which suggests that we should accept our null hypothesis. After the space race, the percentile was well below our null hypothesis, so we can't conclude the variables are corrilated. 
