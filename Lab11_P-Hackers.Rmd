...
###XYEARS BEFORE 1974-1996
```{r}
ggplot(andres, aes(x = year, y = prop)) + geom_line(col = 'turquoise2') + xlim(1974,1996) +
  ggtitle("Proportion of Andres 1974-1996") + xlab("Year") + ylab("Proportion") +
  theme_minimal()
```
###YEARS AFTER 1996 - 2018
```{r}
ggplot(andres, aes(x = year, y = prop)) + geom_line(col = 'turquoise3') + xlim(1996,2018) +
  ggtitle("Proportion of Variants of 'Andres' 1996-2018") + xlab("Year") + ylab("Proportion") +
  theme_minimal()
```
